    ...
    if 2 < len(message.text) < 50:    
        ...
        if len(btn) > 10: 
            ...
            await message.reply_text(
                f"<b> මෙන්න ඔයා හොයන {message.text}</b>",
    ...
    if (clicked == typed) or (clicked in AUTH_USERS):
        ...
        if query.data.startswith("next"):
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("🔰 JOIN WITH US 🔰", url="https://t.me/SL_MEDIA_TECH_GRUOP")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("✨ Bot Owner 🇱🇰", url="https://t.me/Akilawiduruwan")]
            ])
